...
import ImageSlider from "./components/TabButtons/ImageSlider";
import "./App.css";
...
const tabs = [
  { name: "About me", id: 1 },
  { name: "Experiences", id: 2 },
  { name: "Recommended", id: 3 },
];
        ...
        <div className="widget-container1">
          <div className="small-widget-container">
            <div className="content-images-container">
              <div className="vector-rectangles-container">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <div>
                ...
                <div className="scrollable-container">
                  ...
                  This is a...Hello! I’m Dave, your sales rep here from Salesforce. I’ve
                  been working at this awesome company for 3 years now. I was
                  born and raised in Albany, NY& have been living in Santa Carla
                  for the past 10 years my wife Tiffany and my 4 year old twin
                  daughters- Emma and Ella. Both of them are just starting
